    ...
    <div className="min-h-screen bg-linear-to-b from-slate-50 to-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <header className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-blue-900 rounded-full mb-4">
        ...
        <div className="max-w-md mx-auto">
          <Link href="/scan">
            <button className="w-full bg-blue-900 text-white px-8 py-6 rounded-2xl text-lg font-semibold hover:bg-blue-800 transition-colors shadow-lg flex items-center justify-center gap-3 mb-8">
