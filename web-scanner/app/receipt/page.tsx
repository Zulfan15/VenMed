    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 py-8 print-page">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-6 print-content">
            {/* Header */}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 pb-4 border-b border-slate-200">
                <div>
                  <p className="text-xs text-slate-500 mb-1">No. Resep</p>
              ...
              <div className="grid md:grid-cols-2 gap-6 pb-4 border-b border-slate-200">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-sm font-semibold text-slate-800">Pasien</h3>
                  </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <User className="w-4 h-4 text-slate-400" />
                    <h3 className="text-sm font-semibold text-slate-800">Dokter</h3>
                  </div>
                  <p className="text-slate-700">{receipt.doctor_name}</p>
                  <p className="text-xs text-slate-500 mt-1">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-semibold text-slate-800">Daftar Obat</h3>
                </div>
                      ...
                      <div className="mt-3 space-y-1 text-sm">
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            ...
                            <span className="ml-2 text-slate-800">{item.dosage}</span>
                          </div>
                          <div>
                            <span className="text-slate-500">Frekuensi:</span>
                            <span className="ml-2 text-slate-800">{item.frequency}</span>
                          </div>
                          <div>
                            <span className="text-slate-500">Durasi:</span>
                            <span className="ml-2 text-slate-800">{item.duration_days} hari</span>
                          </div>
                          <div>
                            <span className="text-slate-500">Aturan:</span>
                            <span className="ml-2 text-slate-800">{item.instructions}</span>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6 print-hidden">
            <button
              onClick={handlePrint}
              className="flex items-center justify-center gap-2 px-6 py-3 bg-blue-900 text-white rounded-lg font-semibold hover:bg-blue-800 transition-colors"
            >
          ...
          <div className="text-center print-hidden">
            <Link href="/" className="inline-flex items-center gap-2 text-blue-900 hover:underline">
